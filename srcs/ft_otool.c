...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/04/24 19:17:30 by gpetrov           #+#    #+#             */
/*   Updated: 2014/04/24 19:18:08 by gpetrov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		data_init(t_data *data, struct stat *buf, char *file)
{
	...
	data->addr = mmap(0, data->size, PROT_READ | PROT_WRITE, MAP_FILE |
